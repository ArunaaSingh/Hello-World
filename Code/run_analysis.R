...
activities <- read.table(file.choose(), col.names = c("code", "activity"))
subject_test <- read.table(file.choose(), col.names = "subject")
x_test <- read.table(file.choose(), col.names = features$functions)
y_test <- read.table(file.choose(), col.names = "code")
subject_train <- read.table(file.choose(), col.names = "subject")
